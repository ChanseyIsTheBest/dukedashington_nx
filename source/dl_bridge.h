 ...
 *    DD_SDL_SENTINEL so that lookup lands in sdl_bridge.c, which fills
 ...
 */
#ifndef DD_DL_BRIDGE_H
#define DD_DL_BRIDGE_H

#include <stddef.h>

#define DD_SDL_SENTINEL "libSDL2-switch-native.so"
