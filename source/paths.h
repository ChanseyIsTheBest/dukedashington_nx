 ...
 *
 *   <folder>/dukedashington.nro      <folder>/dukedashington.nro
 ...
 *
 * save/, config.txt and duke.log are created inside whichever folder is found.
...
#define DD_PACKAGE "com.adventureislands.dukedashingtonremastered"
...
const char *paths_root(void);          /* sdmc:/switch/dukedashington_nx      */
const char *paths_assets(void);        /* <root>/assets, or <root>            */
const char *paths_assets_nodev(void);  /* /switch/dukedashington_nx/assets    */
const char *paths_save(void);          /* <root>/save                         */
const char *paths_save_nodev(void);    /* /switch/dukedashington_nx/save      */
