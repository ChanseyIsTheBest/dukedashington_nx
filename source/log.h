/* log.h -- duke.log next to the game files.
 *
...
#define DD_LOG_OFF   0
#define DD_LOG_INFO  1
#define DD_LOG_DEBUG 2
...
#define LOGD(...) do { if (log_get_level() >= DD_LOG_DEBUG) log_printf(__VA_ARGS__); } while (0)
